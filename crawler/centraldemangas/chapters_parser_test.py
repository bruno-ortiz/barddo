...
class CommonChapterParserTest(unittest.TestCase):
    ...
    def test_can_fetch_manga_chapters(self):
        url = "http://centraldemangas.net/mangas/info/gantz"
        html, _ = get_html(url)
    ...
    def test_can_fetch_only_cdm_chapters(self):
        self.assertTrue(self.parser.should_parse("http://centraldemangas.net/mangas/info/gantz"))
...
class CustomPageChapterParserTest(unittest.TestCase):
    ...
    def test_can_fetch_only_cdm_chapters(self):
        self.assertFalse(self.parser.should_parse("http://centraldemangas.net/mangas/info/gantz"))
