...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RemotePage.sequence'
        db.alter_column(u'core_remotepage', 'sequence', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Adding field 'Collection.last_updated'
        db.add_column(u'core_collection', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 5, 0, 0), auto_now=True, db_index=True, auto_now_add=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RemotePage.sequence'
        db.alter_column(u'core_remotepage', 'sequence', self.gf('core.models.AutoIncrementField')())
        # Deleting field 'Collection.last_updated'
        db.delete_column(u'core_collection', 'last_updated')
    ...
    models = {
        ...
        u'core.collection': {
            ...
            'extra_data': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 5, 0, 0)', 'auto_now': 'True', 'db_index': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
