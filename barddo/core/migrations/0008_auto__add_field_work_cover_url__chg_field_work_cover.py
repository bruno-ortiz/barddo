...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Work.cover_url'
        db.add_column(u'core_work', 'cover_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Work.cover'
        db.alter_column(u'core_work', 'cover', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Work.cover_url'
        db.delete_column(u'core_work', 'cover_url')


        # User chose to not deal with backwards NULL issues for 'Work.cover'
        raise RuntimeError("Cannot reverse this migration. 'Work.cover' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Work.cover'
        db.alter_column(u'core_work', 'cover', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
