...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Work.price'
        db.add_column(u'core_work', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=6, decimal_places=2, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Work.price'
        db.delete_column(u'core_work', 'price')
