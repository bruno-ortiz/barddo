...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RemotePage'
        db.create_table(u'core_remotepage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sequence', self.gf('core.models.AutoIncrementField')()),
            ('work', self.gf('django.db.models.fields.related.ForeignKey')(related_name='remote_pages', to=orm['core.Work'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['RemotePage'])
        ...
        # Adding field 'Collection.cover_url'
        db.add_column(u'core_collection', 'cover_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RemotePage'
        db.delete_table(u'core_remotepage')

        # Deleting field 'Collection.extra_data'
        db.delete_column(u'core_collection', 'extra_data')

        # Deleting field 'Collection.cover_url'
        db.delete_column(u'core_collection', 'cover_url')
