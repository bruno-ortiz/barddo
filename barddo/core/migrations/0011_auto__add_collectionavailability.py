...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CollectionAvailability'
        db.create_table(u'core_collectionavailability', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('collection', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Collection'], unique=True)),
            ('modify_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 11, 4, 0, 0), auto_now=True, db_index=True, auto_now_add=True, blank=True)),
            ('status', self.gf('django.db.models.fields.SmallIntegerField')(default=0, db_index=True)),
        ))
        db.send_create_signal(u'core', ['CollectionAvailability'])


    def backwards(self, orm):
        # Deleting model 'CollectionAvailability'
        db.delete_table(u'core_collectionavailability')
    ...
    models = {
        ...
        u'core.collection': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 4, 0, 0)', 'auto_now': 'True', 'db_index': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'core.collectionavailability': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modify_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 4, 0, 0)', 'auto_now': 'True', 'db_index': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '0', 'db_index': 'True'})
        },
        u'core.remotepage': {
