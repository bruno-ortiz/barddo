...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'BarddoUserProfile.language'
        db.add_column(u'accounts_barddouserprofile', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=5),
                      keep_default=False)


        # Changing field 'BarddoUserProfile.country'
        db.alter_column(u'accounts_barddouserprofile', 'country', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Deleting field 'BarddoUserProfile.language'
        db.delete_column(u'accounts_barddouserprofile', 'language')
