...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_bankaccount', (
            ...
            ('bank_code', self.gf('django.db.models.fields.CharField')(max_length=5)),
    ...
    models = {
        u'accounts.bankaccount': {
            ...
            'bank_code': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
        ...
        u'accounts.barddouserprofile': {
            ...
            'birth_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 14, 0, 0)'}),
