...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BarddoUser.is_publisher'
        db.add_column(u'accounts_barddouser', 'is_publisher',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BarddoUser.is_publisher'
        db.delete_column(u'accounts_barddouser', 'is_publisher')
    ...
    models = {
        ...
        u'accounts.barddouserprofile': {
            ...
            'birth_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 2, 0, 0)'}),
