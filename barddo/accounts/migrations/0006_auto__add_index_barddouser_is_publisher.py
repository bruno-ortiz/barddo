...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'BarddoUser', fields ['is_publisher']
        db.create_index(u'accounts_barddouser', ['is_publisher'])


    def backwards(self, orm):
        # Removing index on 'BarddoUser', fields ['is_publisher']
        db.delete_index(u'accounts_barddouser', ['is_publisher'])
    ...
    models = {
        ...
        u'accounts.barddouserprofile': {
            ...
            'birth_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 14, 0, 0)'}),
