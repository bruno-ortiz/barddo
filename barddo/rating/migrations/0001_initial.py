...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rating_rating', (
            ...
            ('work', self.gf('django.db.models.fields.related.ForeignKey')(related_name='like', to=orm['core.Work'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('like', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'rating', ['Rating'])

        # Adding unique constraint on 'Rating', fields ['user', 'work']
        db.create_unique(u'rating_rating', ['user_id', 'work_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Rating', fields ['user', 'work']
        db.delete_unique(u'rating_rating', ['user_id', 'work_id'])
    ...
    models = {
        ...
        u'rating.rating': {
            'Meta': {'unique_together': "(('user', 'work'),)", 'object_name': 'Rating'},
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'like': ('django.db.models.fields.BooleanField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.BarddoUser']"}),
            'work': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'like'", 'to': u"orm['core.Work']"})
        }
    }
